...
Abstract:
  ...
  BhyveGopDriver.c file which deals with the EFI 1.1 driver model.
...
/**
  Blt a rectangle of pixels to to framebuffer. Blt stands for BLock Transfer.
  ...
  )
{
  ...
  Private->GraphicsOutput.SetMode        = BhyveGopSetMode;
  Private->GraphicsOutput.Blt            = BhyveGopBlt;
...
Routine Description:
  ...
  All we do here is call BhyveGopDestructor().
